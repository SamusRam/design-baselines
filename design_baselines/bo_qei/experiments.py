...
@cli.command()
@click.option('--local-dir', type=str, default='bo-qei-aav')
@click.option('--cpus', type=int, default=24)
@click.option('--gpus', type=int, default=1)
@click.option('--num-parallel', type=int, default=1)
@click.option('--num-samples', type=int, default=1)
...
@cli.command()
@click.option('--local-dir', type=str, default='bo-qei-gb1')
@click.option('--cpus', type=int, default=24)
@click.option('--gpus', type=int, default=1)
@click.option('--num-parallel', type=int, default=1)
@click.option('--num-samples', type=int, default=1)
@click.option('--oracle', type=str, default="Transformer")
@click.option('--difficulty', type=str, default="medium")
def gb1(local_dir, cpus, gpus, num_parallel, num_samples, oracle, difficulty):
    """Evaluate BO-QEI on GB1
    """
